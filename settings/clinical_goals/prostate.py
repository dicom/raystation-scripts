...
class Prostate:
  ...
  def create_oar_clinical_goals(self, ss, plan, prescription):
    ...
    if prescription.total_dose == 36.25:
      ...
      # Femoral heads:
      oars.append(CG.ClinicalGoal(ROIS.femoral_head_l.name, CG.at_most, CG.volume_at_dose, 0.05, TOL.femoral_paceb1, 4))
      oars.append(CG.ClinicalGoal(ROIS.femoral_head_r.name, CG.at_most, CG.volume_at_dose, 0.05, TOL.femoral_paceb1, 4))
      # Penile bulb:
