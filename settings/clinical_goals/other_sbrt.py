  ...
  def create_oar_clinical_goals(self, ss, plan, prescription):
    ...
    if prescription.nr_fractions == 1:
      ...
      if prescription.region_code in RC.stereotactic_spine_thorax_codes:
        ...
        oars.append(CG.ClinicalGoal(ROIS.heart.name, CG.at_most, CG.dose_at_abs_volume, TOL.heart_sbrt_3fx_v0, 0.035, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.esophagus.name, CG.at_most, CG.dose_at_abs_volume, TOL.esophagus_sbrt_3fx_v0, 0.035, 3))
