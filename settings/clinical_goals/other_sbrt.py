...
class OtherSBRT:
  ...
  def create_oar_clinical_goals(self, ss, plan, prescription):
    ...
    if prescription.nr_fractions == 1:
      ...
      oars.append(CG.ClinicalGoal(ROIS.skin.name, CG.at_most, CG.dose_at_abs_volume, TOL.skin_sbrt_1fx_v0, 0, 4))
      if prescription.region_code in RC.stereotactic_spine_thorax_codes:
        ...
        oars.append(CG.ClinicalGoal(ROIS.heart.name, CG.at_most, CG.dose_at_abs_volume, TOL.heart_sbrt_1fx_v0, 0, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.esophagus.name, CG.at_most, CG.dose_at_abs_volume, TOL.esophagus_sbrt_1fx_v0, 0, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.kidney_l.name, CG.at_most, CG.dose_at_volume, TOL.kidney_sbrt_1fx_v0, 0, 3))
        oars.append(CG.ClinicalGoal(ROIS.kidney_r.name, CG.at_most, CG.dose_at_volume, TOL.kidney_sbrt_1fx_v0, 0, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.cauda_equina.name, CG.at_most, CG.dose_at_abs_volume, TOL.cauda_equina_sbrt_1fx_v0, 0, 2))
        oars.append(CG.ClinicalGoal(ROIS.cauda_equina.name, CG.at_most, CG.dose_at_abs_volume, TOL.cauda_equina_sbrt_1fx_v0, 5, 2))
        oars.append(CG.ClinicalGoal(ROIS.small_bowel.name, CG.at_most, CG.dose_at_abs_volume, TOL.small_bowel_sbrt_1fx_v0, 0, 3))
        oars.append(CG.ClinicalGoal(ROIS.small_bowel.name, CG.at_most, CG.dose_at_abs_volume, TOL.small_bowel_sbrt_1fx_v5, 5, 3))
        oars.append(CG.ClinicalGoal(ROIS.rectum.name, CG.at_most, CG.dose_at_abs_volume, TOL.rectum_sbrt_1fx_v0, 0, 3))
      ...
      oars.append(CG.ClinicalGoal(ROIS.skin.name, CG.at_most, CG.dose_at_abs_volume, TOL.skin_col_sbrt_3fx_v0, 0, 4))
      if prescription.region_code in RC.stereotactic_spine_thorax_codes:
        # Spine thorax:
        ...
        oars.append(CG.ClinicalGoal(ROIS.spinal_cord.name, CG.at_most, CG.dose_at_abs_volume, TOL.spinal_canal_sbrt_3fx_v0, 0, 2))
        ...
        oars.append(CG.ClinicalGoal(ROIS.heart.name, CG.at_most, CG.dose_at_abs_volume, TOL.heart_sbrt_3fx_v0, 0, 3))
        oars.append(CG.ClinicalGoal(ROIS.lungs.name, CG.at_most, CG.dose_at_abs_volume, TOL.lung_sbrt_3fx_v1000, 1000, 3))
        oars.append(CG.ClinicalGoal(ROIS.esophagus.name, CG.at_most, CG.dose_at_abs_volume, TOL.esophagus_sbrt_3fx_v5, 5, 3))
        oars.append(CG.ClinicalGoal(ROIS.esophagus.name, CG.at_most, CG.dose_at_abs_volume, TOL.esophagus_sbrt_3fx_v0, 0, 3))
        ...
        # Common for pelvis spine/non-spine:
        oars.append(CG.ClinicalGoal(ROIS.cauda_equina.name, CG.at_most, CG.dose_at_abs_volume, TOL.cauda_equina_sbrt_3fx_v0, 0, 2))
        oars.append(CG.ClinicalGoal(ROIS.cauda_equina.name, CG.at_most, CG.dose_at_abs_volume, TOL.cauda_equina_sbrt_3fx_v5, 5, 2))
        oars.append(CG.ClinicalGoal(ROIS.small_bowel.name, CG.at_most, CG.dose_at_abs_volume, TOL.small_bowel_sbrt_3fx_v0, 0, 3))
        oars.append(CG.ClinicalGoal(ROIS.small_bowel.name, CG.at_most, CG.dose_at_abs_volume, TOL.small_bowel_sbrt_3fx_v5, 5, 3))
        oars.append(CG.ClinicalGoal(ROIS.rectum.name, CG.at_most, CG.dose_at_abs_volume, TOL.rectum_sbrt_3fx_v0, 0, 3))
        oars.append(CG.ClinicalGoal(ROIS.rectum.name, CG.at_most, CG.dose_at_abs_volume, TOL.rectum_sbrt_3fx_v20, 20, 3))
        oars.append(CG.ClinicalGoal(ROIS.colon.name, CG.at_most, CG.dose_at_abs_volume, TOL.colon_sbrt_3fx_v0, 0, 3))
