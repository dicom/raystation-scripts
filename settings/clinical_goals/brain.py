  ...
  def create_oar_clinical_goals(self, ss, plan, prescription):
    ...
    if prescription.region_code in RC.brain_whole_codes:
      ...
      if prescription.nr_fractions == 1:
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_1fx_p1, 0.035, 2))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_1fx_p1, 0.035, 2))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_1fx_p2, 0.035, 3))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_1fx_p2, 0.035, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_3fx_p1, 0.035, 2))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_3fx_p1, 0.035, 2))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_3fx_p2, 0.035, 3))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_3fx_p2, 0.035, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_5fx_p1, 0.035, 2))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_5fx_p1, 0.035, 2))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_5fx_p2, 0.035, 3))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_srt_5fx_p2, 0.035, 3))
        ...
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_l.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_v003_adx, 0.03, 2))
        oars.append(CG.ClinicalGoal(ROIS.optic_nerve_r.name, CG.at_most, CG.dose_at_abs_volume, TOL.optic_nrv_v003_adx, 0.03, 2))
