...
carina = ROI.ROI('Carina','Organ', COLORS.carina)
...
bronchus_intermedius = ROI.ROI('BronchusIntermedius','Organ', COLORS.bronchus_intermedius)
...
bronchial_tree = ROI.ROIAlgebra('BronchialTree', 'Organ', COLORS.trachea, sourcesA = [trachea], sourcesB = [carina, main_bronchus_l, main_bronchus_r, bronchus_intermedius, bronchi_lobar_l, bronchi_lobar_r], operator = 'Union')
# Spine SBRT:
