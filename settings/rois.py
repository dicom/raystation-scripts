...
scalene_muscle_l = ROI.ROI('ScaleneMuscle_Ant_L', 'Undefined', COLORS.muscle)
scalene_muscle_r = ROI.ROI('ScaleneMuscle_Ant_R', 'Undefined', COLORS.muscle)
...
iliopsoas_muscle_l = ROI.ROI('IliopsoasMuscle_L', 'Organ', COLORS.muscle, 'Alesund Male Pelvic CT')
iliopsoas_muscle_r = ROI.ROI('IliopsoasMuscle_R', 'Organ', COLORS.muscle, 'Alesund Male Pelvic CT')
