...
bowel_small = ROI.ROI('BowelSmall','Organ', COLORS.bowel_small)
...
ribs_l = ROI.ROI('Ribs_L','Organ', COLORS.ribs)
ribs_r = ROI.ROI('Ribs_R','Organ', COLORS.ribs)
...
ctv_sb_l = ROI.ROI('CTVsb_L', 'Ctv', COLORS.ctv)
ctv_sb_r = ROI.ROI('CTVsb_R', 'Ctv', COLORS.ctv)
...
ptv_sbc_l = ROI.ROI('PTVsbc_L', 'Ptv', COLORS.ptv)
ptv_sbc_r = ROI.ROI('PTVsbc_R', 'Ptv', COLORS.ptv)
# Rectum:
...
a_lad = ROI.ROIDLS('A_LAD','Organ', COLORS.a_lad, 'RSL DLS CT')
...
bronchus_main_l = ROI.ROIDLS('BronchusMain_L','Organ', COLORS.bronchus_main, 'RSL DLS CT', lib_name = 'Bronchus_Main_L')
bronchus_main_r = ROI.ROIDLS('BronchusMain_R','Organ', COLORS.bronchus_main, 'RSL DLS CT', lib_name = 'Bronchus_Main_R')
carina = ROI.ROIDLS('Carina','Organ', COLORS.carina, 'RSL DLS CT')
cauda_equina = ROI.ROIDLS('CaudaEquina', 'Organ', COLORS.cauda_equina, 'Alesund Male Pelvic CT')
...
cricopharyngeus = ROI.ROIDLS('Cricopharyngeus','Organ', COLORS.muscle, 'RSL DLS CT', lib_name = 'CPM')
...
femoral_head_l = ROI.ROIDLS('FemoralHead_L', 'Organ', COLORS.femoral_head, 'RSL DLS CT', lib_name = 'Femur_Head_L')
femoral_head_r = ROI.ROIDLS('FemoralHead_R', 'Organ', COLORS.femoral_head, 'RSL DLS CT', lib_name = 'Femur_Head_R')
...
larynx_glottis = ROI.ROIDLS('LarynxGlottis','Organ', COLORS.larynx_glottis, 'RSL DLS CT', lib_name = 'Larynx_G')
larynx_supraglottis = ROI.ROIDLS('LarynxSupraglottis','Organ', COLORS.larynx_supraglottis, 'RSL DLS CT', lib_name = 'Larynx_SG')
lens_l = ROI.ROIDLS('Lens_L', 'Organ', COLORS.lens, 'RSL DLS CT')
lens_r = ROI.ROIDLS('Lens_R', 'Organ', COLORS.lens, 'RSL DLS CT')
liver = ROI.ROIDLS('Liver','Organ', COLORS.liver, 'RSL DLS CT')
...
mandible = ROI.ROIDLS('Mandible', 'Organ', COLORS.bone_color3, 'RSL DLS CT')
optic_chiasm = ROI.ROIDLS('OpticChiasm','Organ', COLORS.chiasma, 'RSL DLS CT')
optic_nerve_l = ROI.ROIDLS('OpticNerve_L', 'Organ', COLORS.optic_nerve, 'RSL DLS CT')
optic_nerve_r = ROI.ROIDLS('OpticNerve_R', 'Organ', COLORS.optic_nerve, 'RSL DLS CT')
