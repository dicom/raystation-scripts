...
class Rectum:
  ...
  def create_oar_objectives(self, ss, plan, prescription, i):
    ...
    if prescription.total_dose == 50:
      ...
      oars.append(OF.max_dvh(ss, plan, ROIS.femoral_head_l.name, 15*100, 2, 1, beam_set_index=i))
      oars.append(OF.max_dvh(ss, plan, ROIS.femoral_head_r.name, 15*100, 2, 1, beam_set_index=i))
    else:
      ...
      oars.append(OF.max_dvh(ss, plan, ROIS.femoral_head_l.name, 7.5*100, 2, 1, beam_set_index=i))
      oars.append(OF.max_dvh(ss, plan, ROIS.femoral_head_r.name, 7.5*100, 2, 1, beam_set_index=i))
