  ...
  def create_oar_objectives(self, ss, plan, prescription, i):
    ...
    if prescription.region_code in RC.prostate_bed_codes:
      ...
      if prescription.region_code in RC.prostate_node_codes:
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 35*100, 1, 1, beam_set_index=i))
      else:
        # Prostate bed only:
        oars.append(OF.max_eud(ss, plan, ROIS.rectum.name, 25*100, 1, 4, beam_set_index=i))
      ...
      if prescription.total_dose == 67.5 and prescription.region_code in RC.prostate_node_codes:
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.bone.name, 25*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 33.75*100, 1, 1, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 30*100, 1, 1, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 18*100, 1, 1, beam_set_index=i))
      else:
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_l.name, 7*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_r.name, 7*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 20*100, 1, 1, beam_set_index=i))
