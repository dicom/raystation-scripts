  ...
  def create_oar_objectives(self, ss, plan, prescription, i):
    ...
    if prescription.region_code in RC.prostate_bed_codes:
      ...
      if prescription.region_code in RC.prostate_node_codes:
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.rectum.name, 60*100, 1, 4, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.anal_canal.name, 45*100, 1, 2, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_l.name, 15*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_r.name, 15*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.bone.name, 30*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 70*100, 1, 1, beam_set_index=i))
      else:
        # Prostate bed only:
        oars.append(OF.max_eud(ss, plan, ROIS.rectum.name, 60*100, 1, 4, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.anal_canal.name, 45*100, 1, 2, beam_set_index=i))
      ...
      if prescription.total_dose == 67.5 and prescription.region_code in RC.prostate_node_codes:
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_r.name, 15*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.bone.name, 30*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 67.5*100, 1, 1, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.rectum.name, 50*100, 1, 4, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.anal_canal.name, 40*100, 1, 2, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.bladder.name, 50*100, 1, 2, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 60*100, 1, 1, beam_set_index=i))
      elif prescription.total_dose == 36.25:
        # Favorable intermediate prostate (SBRT):
        oars.append(OF.max_eud(ss, plan, ROIS.bladder.name, 30*100, 1, 2, beam_set_index=i))
        ...
        oars.append(OF.max_eud(ss, plan, ROIS.anorectum.name, 25*100, 1, 2, beam_set_index=i))
        oars.append(OF.max_dvh(ss, plan, ROIS.anorectum.name, 35*100, 0.1, 50, beam_set_index=i))
        oars.append(OF.max_dvh(ss, plan, ROIS.urethra.name, 42*100, 40, 10, beam_set_index=i))
        oars.append(OF.max_dose(ss, plan, ROIS.urethra.name, 42*100, 5, beam_set_index=i))   
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 36.25*100, 1, 1, beam_set_index=i))
      else:
        # STAMPEDE or palliative:
        oars.append(OF.max_eud(ss, plan, ROIS.rectum.name, 45*100, 1, 4, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.anal_canal.name, 35*100, 1, 2, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.bladder.name, 45*100, 1, 2, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_l.name, 12*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.femoral_head_r.name, 12*100, 1, 1, beam_set_index=i))
        oars.append(OF.max_eud(ss, plan, ROIS.penile_bulb.name, 55*100, 1, 1, beam_set_index=i))
