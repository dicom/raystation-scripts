...
def setup_beams(ss, examination, beam_set, isocenter, prescription, technique_name, energy_name, iso_index = 1, beam_index=1):
  bolus = SSF.bolus(ss)
  if technique_name == '3D-CRT':
    ...
    elif prescription.region_code in RC.breast_partial_l_codes:
    ...
    # Lung:
      ...
      elif prescription.region_code in RC.lung_l_codes:
        # Left:
      ...
      if prescription.fraction_dose > 8:
