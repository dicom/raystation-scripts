...
prostate_bone_match_expansion = MARGIN.Expansion(0.8, 0.8, 0.8, 0.8, 0.5, 0.5)
prostate_lymph_nodes_seed_match = MARGIN.Expansion(0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
prostate_seed_expansion = MARGIN.Expansion(0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
prostate_bed = MARGIN.Expansion(0.7, 0.7, 0.9, 0.9, 0.5, 0.5)
