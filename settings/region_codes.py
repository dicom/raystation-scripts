...
palliative_thorax_codes = range(30, 43+1) + range(200, 223+1) + range(231, 238+1) + range(251, 260+1) + range(417, 419+1) + range(518, 521+1) + range(530, 538+1)
...
palliative_abdomen_codes.extend((315, 316, 523, 351, 352))
