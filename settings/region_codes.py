...
palliative_thorax_codes = range(30, 43+1) + range(200, 223+1) + range(231, 238+1) + range(251, 258+1) + range(417, 419+1) + range(518, 520+1) + range(530, 538+1)
...
palliative_pelvis_codes = range(70, 85+1) +range(342, 349+1) + range(353, 354+1) + range(512, 514+1) + range(525, 527+1) + range(541, 546+1)
