...
lung_mean_reg_15fx = EQD.Tolerance('Lung_L/R', 'Pneumonitis', ab_lung, 15, 16, 'Mean', 'Conventional RT')
lung_mean_reg_15fx_secondary = EQD.Tolerance('Lung_L/R', 'Pneumonitis', ab_lung, 15, 8, 'Mean', 'Conventional RT')
...
heart_v1_5_fastforward = EQD.Tolerance('Heart', 'Some failure', ab_heart, 5, 1.5, 'Volume receiving tolerance dose being less than 25%', 'Conventional RT')
...
lung_v35_adx_25 = EQD.Tolerance('Lung', 'Pneumonitis', ab_lung, fractions_breast, 20, 'Volume receiving tolerance dose being less than 35%', 'Conventional RT')
lung_v35_adx_15 = EQD.Tolerance('Lung', 'Pneumonitis', ab_lung, fractions_breast_15, 18, 'Volume receiving tolerance dose being less than 35%', 'Conventional RT')
lung_v35 = EQD.Tolerance('Lung', 'Pneumonitis', ab_lung, fractions_breast_15, 17, 'Volume receiving tolerance dose being less than 35%', 'Conventional RT')
...
# SBRT (PACE-B):
bladder_paceb1 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 37, 'Volume receiving tolerance dose being less than 20 cm^3', 'SBRT')
bladder_paceb2 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 18.1, 'Volume receiving tolerance dose being less than 40 %', 'SBRT')
bladder_paceb3 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 37, 'Volume receiving tolerance dose being less than 10 cm^3', 'SBRT')
bladder_paceb4 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 37, 'Volume receiving tolerance dose being less than 5 cm^3', 'SBRT')
bowel_paceb1 = EQD.Tolerance('BowelBag', 'GI tox', ab_bowel, 5, 18.1, 'Volume receiving tolerance dose being less than 5 cm^3', 'SBRT')
bowel_paceb2 = EQD.Tolerance('BowelBag', 'GI tox', ab_bowel, 5, 30, 'Volume receiving tolerance dose being less than 1 cm^3', 'SBRT')
femoral_paceb1 = EQD.Tolerance('Femoral_Head_L/R', 'Fracture/Osteoarthritis', ab_femoral, 5, 14.5, 'Volume receiving tolerance dose being less than 5 %', 'SBRT')
penile_bulb_paceb1 = EQD.Tolerance('PenileBulb', 'Erectile dysfuncion', ab_penile_bulb, 5, 29.5, 'Volume receiving tolerance dose being less than 50 %', 'SBRT')
rectum_paceb1 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 36, 'Volume receiving tolerance dose being less than 2 cm^3', 'SBRT')
rectum_paceb2 = EQD.Tolerance('Rectum', 'GI tox', ab_rectum, 5, 18.1, 'Volume receiving tolerance dose being less than 50 %', 'SBRT')
rectum_paceb3 = EQD.Tolerance('Rectum', 'GI tox', ab_rectum, 5, 29, 'Volume receiving tolerance dose being less than 20 %', 'SBRT')
rectum_paceb4 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 36, 'Volume receiving tolerance dose being less than 1 cm^3', 'SBRT')
urethra_paceb1 = EQD.Tolerance('Urethra', 'GU tox', ab_bladder, 5, 42, 'Volume receiving tolerance dose being less than 50 %', 'SBRT')
...
kidneys_col_1fx_v200 = EQD.Tolerance('Kidneys', 'Basal kidney function', ab_kidneys, fractions_sbrt_1, 8.4, 'Volume receiving tolerance dose being less than 200cm3', 'SBRT')
