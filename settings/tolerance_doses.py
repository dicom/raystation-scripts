...
# SBRT (PACE-B):
bladder_paceb1 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 18.1, 'Volume receiving tolerance dose being less than 40 %', 'SBRT')
bladder_paceb2 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 37, 'Volume receiving tolerance dose being less than 10 cm^3', 'SBRT')
bladder_paceb3 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 37, 'Volume receiving tolerance dose being less than 5 cm^3', 'SBRT')
...
rectum_paceb1 = EQD.Tolerance('Rectum', 'GI tox', ab_rectum, 5, 18.1, 'Volume receiving tolerance dose being less than 50 %', 'SBRT')
rectum_paceb2 = EQD.Tolerance('Rectum', 'GI tox', ab_rectum, 5, 29, 'Volume receiving tolerance dose being less than 20 %', 'SBRT')
rectum_paceb3 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 36, 'Volume receiving tolerance dose being less than 1 cm^3', 'SBRT')
rectum_paceb4 = EQD.Tolerance('Bladder', 'GU tox', ab_bladder, 5, 36, 'Volume receiving tolerance dose being less than 2 cm^3', 'SBRT')
