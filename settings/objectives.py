...
palliative_thorax_oar_objectives =  [ROIS.spinal_canal, ROIS.heart, ROIS.liver, ROIS.lungs]
palliative_thorax_and_abdomen_oar_objectives =  [ROIS.spinal_canal, ROIS.heart, ROIS.liver, ROIS.lungs, ROIS.kidneys, ROIS.bowel_space]
...
def create_prostate_objectives(ss, plan, total_dose):
  if total_dose == 60:
    ...
    OF.max_dvh(ss, plan, ROIS.femoral_l.name, 30*100, 2, 1)
    OF.max_dvh(ss, plan, ROIS.femoral_r.name, 30*100, 2, 1)
