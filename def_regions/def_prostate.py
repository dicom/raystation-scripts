  ...
  def __init__(self, pm, examination, ss, choices, site):
    ...
    if region == 'prostate':
      ...
      if frac == 'normo':
        ...
        nodes = choices[3]
        # Targets:
        ctv_77 = ROI.ROIAlgebra(ROIS.ctv_77.name, ROIS.ctv_77.type, COLORS.ctv_high, sourcesA = [ROIS.prostate], sourcesB = [ROIS.rectum, ROIS.anal_canal, ROIS.levator_ani], operator = 'Subtraction', marginsA = MARGINS.prostate_ctv, marginsB = MARGINS.zero)
        ...
        nodes = choices[3]
        # Targets:
        ctv_67_5 = ROI.ROIAlgebra(ROIS.ctv_67_5.name, ROIS.ctv_67_5.type, COLORS.ctv_high, sourcesA = [ROIS.prostate], sourcesB = [ROIS.rectum, ROIS.anal_canal, ROIS.levator_ani], operator = 'Subtraction', marginsA = MARGINS.prostate_ctv, marginsB = MARGINS.zero)
        ptv_67_5 = ROI.ROIExpanded(ROIS.ptv_67_5.name, ROIS.ptv_67_5.type, COLORS.ptv_high, source = ctv_67_5, margins = MARGINS.prostate_seed_expansion)
        # Seminal vesicles (for high risk 20 mm):
        semves20 = ROI.ROIAlgebra('SeminalVes20', ROIS.ctv.type, COLORS.vesicles, sourcesA = [ROIS.vesicles], sourcesB = [ROIS.prostate], operator = 'Intersection', marginsA = MARGINS.zero, marginsB = MARGINS.uniform_20mm_expansion)
        # OARs:
        ...
        wall_ptv_67_5 = ROI.ROIWall(ROIS.z_ptv_67_5_wall.name, ROIS.z_ptv_67_5_wall.type, COLORS.wall, ptv_67_5, 0.5, 0)
        if nodes == 'no':
          # Prostate only:
          # Targets:
          ctv_62_5 = ROI.ROIAlgebra(ROIS.ctv_62_5_sib.name, ROIS.ctv_62_5.type, COLORS.ctv_med, sourcesA = [semves20], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv_62_5 = ROI.ROIAlgebra(ROIS.ptv_62_5_sib.name, ROIS.ptv_62_5.type, COLORS.ptv_med, sourcesA = [semves20], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.uniform_8mm_expansion, marginsB = MARGINS.zero)
          ptv_62_5_67_5 = ROI.ROIAlgebra(ROIS.ptv_62_5_67_5.name, ROIS.ptv_62_5_67_5.type, COLORS.ptv_low, sourcesA = [ctv_67_5], sourcesB = [semves20], marginsA = MARGINS.prostate_seed_expansion, marginsB = MARGINS.uniform_8mm_expansion)
          site.add_targets([ptv_62_5_67_5])
          # OARs:
          ...
          ctv_n = ROI.ROIExpanded(ROIS.ctv_n.name, ROIS.ctv_n.type, COLORS.pelvic_nodes, source = ROIS.gtv_n, margins = MARGINS.uniform_5mm_expansion)
          ptv_n = ROI.ROIExpanded(ROIS.ptv_n.name, ROIS.ptv_n.type, ROIS.ptv_n.color, source = ctv_n, margins = MARGINS.prostate_lymph_nodes_seed_expansion)
          ctv_62_5 = ROI.ROIAlgebra(ROIS.ctv_62_5_sib.name, ROIS.ctv_62_5.type, COLORS.ctv_med, sourcesA = [semves20, ctv_n], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv_semves = ROI.ROIAlgebra(ROIS.ptv_semves.name, ROIS.ptv_semves.type, COLORS.ptv_med, sourcesA = [semves20], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.uniform_8mm_expansion, marginsB = MARGINS.zero)
          ptv_62_5 = ROI.ROIAlgebra(ROIS.ptv_62_5_sib.name, ROIS.ptv_62_5_sib.type, ROIS.ptv_62_5_sib.color, sourcesA = [ptv_semves, ptv_n], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv_62_5_67_5 = ROI.ROIAlgebra(ROIS.ptv_62_5_67_5.name, ROIS.ptv_62_5_67_5.type, COLORS.ptv_low, sourcesA = [ptv_62_5], sourcesB = [ptv_67_5], marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv__50 = ROI.ROIAlgebra(ROIS.ptv__50.name, ROIS.ptv__50.type, COLORS.ptv_low, sourcesA = [ROIS.pelvic_nodes], sourcesB = [ptv_67_5, ptv_62_5], operator = 'Subtraction', marginsA = MARGINS.prostate_lymph_nodes_seed_expansion, marginsB = MARGINS.zero)
          ctv__50 = ROI.ROIAlgebra(ROIS.ctv__50.name, ROIS.ctv__50.type, COLORS.ctv_low, sourcesA = [ROIS.pelvic_nodes], sourcesB = [ptv_67_5, ptv_62_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv_50_62_5_67_5 = ROI.ROIAlgebra(ROIS.ptv_50_62_5_67_5.name, ROIS.ptv_50_62_5_67_5.type, COLORS.ptv_low, sourcesA = [ptv__50, ptv_62_5], sourcesB = [ptv_67_5], marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          site.add_targets([ROIS.gtv_n, ROIS.pelvic_nodes, ctv_n, ctv__50, ptv_n, ptv_semves, ptv__50, ptv_62_5_67_5, ptv_50_62_5_67_5])
          # OARs:
          bladder_ptv.sourcesB.extend([ptv_62_5, ptv__50])
          ...
          wall_ptv_50_62_5_67_5 = ROI.ROIWall(ROIS.z_ptv_50_62_5_67_5_wall.name, ROIS.z_ptv_50_62_5_67_5_wall.type, COLORS.wall, ptv_50_62_5_67_5, 1, 0)
          # DL OARs (and targets):
          examination.RunOarSegmentation(ModelName="RSL DLS Male Pelvic CT", ExaminationsAndRegistrations={ examination.Name: None }, RoisToInclude=["Bladder", "Prostate_1", "SeminalVes"])
          examination.RunOarSegmentation(ModelName="Alesund Male Pelvic CT", ExaminationsAndRegistrations={ examination.Name: None }, RoisToInclude=["LN_Iliac", "CaudaEquina", "Kidney_L", "Kidney_R", "Liver", "BowelBag_Draft", "Rectum", "AnalCanal", "Testis_L", "Testis_R", "IliopsoasMuscle_L", "IliopsoasMuscle_R", "L2", "L3", "L4", "L5", "Sacrum", "Coccyx", "PelvicGirdle_L", "PelvicGirdle_R", "FemurHeadNeck_L", "FemurHeadNeck_R", "A_DescendingAorta", "A_CommonIliac_L", "A_CommonIliac_R", "A_ExternalIliac_L", "A_ExternalIliac_R", "A_InternalIliac_L", "A_InternalIliac_R", "V_InferiorVenaCava", "V_CommonIliac_L", "V_CommonIliac_R", "V_ExternalIliac_L", "V_ExternalIliac_R", "V_InternalIliac_L", "V_InternalIliac_R"])
          # Non-DL OARs:
          site.add_oars(DEF.prostate_non_dl_oars + [bladder_ptv, rectum_ptv, wall_ptv_67_5] + [bowel_ptv, wall_ptv_62_5_67_5, wall_ptv_50_62_5_67_5])
        elif nodes == 'with':
          # Elective nodes:
          # Targets:
          ctv_62_5 = ROI.ROIAlgebra(ROIS.ctv_62_5_sib.name, ROIS.ctv_62_5.type, COLORS.ctv_med, sourcesA = [semves20], sourcesB = [ptv_67_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ...
          ctv__50 = ROI.ROIAlgebra(ROIS.ctv__50.name, ROIS.ctv__50.type, COLORS.ctv_low, sourcesA = [ROIS.pelvic_nodes], sourcesB = [ptv_67_5, ptv_62_5], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          ptv_50_62_5_67_5 = ROI.ROIAlgebra(ROIS.ptv_50_62_5_67_5.name, ROIS.ptv_50_62_5_67_5.type, COLORS.ptv_low, sourcesA = [ptv__50, ptv_62_5], sourcesB = [ptv_67_5], marginsA = MARGINS.zero, marginsB = MARGINS.zero)
          site.add_targets([ROIS.pelvic_nodes, ctv__50, ptv__50, ptv_62_5_67_5, ptv_50_62_5_67_5])
          # OARs:
          bladder_ptv.sourcesB.extend([ptv_62_5, ptv__50])
          rectum_ptv.sourcesB.extend([ptv_62_5, ptv__50])
          bowel_ptv = ROI.ROIAlgebra(ROIS.z_spc_bowel.name, ROIS.z_spc_bowel.type, COLORS.bowel_space, sourcesA = [ROIS.bowel_space], sourcesB = [ptv_67_5, ptv_62_5, ptv__50], operator='Subtraction', marginsB = MARGINS.uniform_3mm_expansion)
      ...
      if frac == 'normo':
        ...
        if nodes == 'no':
          ...
          examination.RunOarSegmentation(ModelName="Alesund Male Pelvic CT", ExaminationsAndRegistrations={ examination.Name: None }, RoisToInclude=["LN_Iliac", "CaudaEquina", "Kidney_L", "Kidney_R", "Liver", "BowelBag_Draft", "Rectum", "AnalCanal", "Testis_L", "Testis_R", "IliopsoasMuscle_L", "IliopsoasMuscle_R", "L2", "L3", "L4", "L5", "Sacrum", "Coccyx", "PelvicGirdle_L", "PelvicGirdle_R", "FemurHeadNeck_L", "FemurHeadNeck_R", "A_DescendingAorta", "A_CommonIliac_L", "A_CommonIliac_R", "A_ExternalIliac_L", "A_ExternalIliac_R", "A_InternalIliac_L", "A_InternalIliac_R", "V_InferiorVenaCava", "V_CommonIliac_L", "V_CommonIliac_R", "V_ExternalIliac_L", "V_ExternalIliac_R", "V_InternalIliac_L", "V_InternalIliac_R"])
        # Non-DL OARs:
        site.add_oars([ROIS.penile_bulb, ROIS.bowel_bag, bladder_ptv, rectum_ptv])
        if nodes != 'no':
        ...
        site.add_oars([ROIS.penile_bulb, ROIS.bowel_bag, bladder_ptv, rectum_ptv, wall_ptv])
    # Change type to 'Other' for selected ROIs:
    for roi_name in ['Prostate','SeminalVes','LN_Iliac','BowelBag_Draft']:
      try:
