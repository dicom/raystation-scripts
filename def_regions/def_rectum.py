  ...
  def __init__(self, pm, examination, ss, choices, site):
    ...
    if frac == 'normo':
      ...
      if groin:
        ...
        ctv_47_50 =  ROI.ROIAlgebra(ROIS.ctv_47_50.name, ROIS.ctv_47_50.type, COLORS.ctv_low, sourcesA=[ROIS.ctv_e], sourcesB=[ROIS.ctv_groin_l, ROIS.ctv_groin_r])
        ptv_47_50 =  ROI.ROIAlgebra(ROIS.ptv_47_50.name, ROIS.ptv_47_50.type, COLORS.ptv_low, sourcesA=[ROIS.ctv_e], sourcesB=[ROIS.ctv_groin_l, ROIS.ctv_groin_r], operator = 'Union', marginsA = MARGINS.rectum_ctv_primary_risk_expansion, marginsB = MARGINS.uniform_5mm_expansion )
        site.add_targets([ROIS.gtv_p, ROIS.gtv_n1, ROIS.gtv_groin_l, ROIS.gtv_groin_r, gtv, ROIS.ctv_groin_l, ROIS.ctv_groin_r, ctv_47_50, ptv_47_50])
      # Without groin targets:
        ...
        #ctv_47_50 = ROI.ROIExpanded(ROIS.ctv_47_50.name, ROIS.ctv_47_50.type, COLORS.ctv_low, source = ROIS.ctv_e)
        #ptv_47_50 = ROI.ROIExpanded(ROIS.ptv_47_50.name, ROIS.ptv_47_50.type, COLORS.ptv_low, source = ROIS.ctv_e, margins = MARGINS.rectum_ctv_primary_risk_expansion)
        #site.add_targets([ROIS.gtv_p, ROIS.gtv_n1, gtv, ctv_47_50, ptv_47_50])
      ...
      if not groin:
        ctv_47_50 = ROI.ROIAlgebra(ROIS.ctv_47_50.name, ROIS.ctv_47_50.type, COLORS.ctv_alt, sourcesA = [ROIS.ctv_e], sourcesB = [ctv_50], operator = 'Union', marginsA = MARGINS.zero, marginsB = MARGINS.zero)
        ptv_47_50 = ROI.ROIAlgebra(ROIS.ptv_47_50.name, ROIS.ptv_47_50.type, COLORS.ptv_low, sourcesA = [ROIS.ctv_e], sourcesB = [ptv_50], operator = 'Union', marginsA = MARGINS.rectum_ctv_primary_risk_expansion, marginsB = MARGINS.zero)
        site.add_targets([ctv_47_50, ptv_47_50])
      ctv_47 =  ROI.ROIAlgebra(ROIS.ctv_47.name, ROIS.ctv_47.type, COLORS.ctv_low, sourcesA=[ctv_47_50], sourcesB=[ptv_50], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero )
      ptv_47 =  ROI.ROIAlgebra(ROIS.ptv_47.name, ROIS.ptv_47.type, COLORS.ptv_med, sourcesA=[ptv_47_50], sourcesB=[ptv_50], operator = 'Subtraction', marginsA = MARGINS.zero, marginsB = MARGINS.zero )
      ...
      site.add_targets([ROIS.ctv_e, ctv_47, ctv_50, ptv_50, ptv_47])
