...
# Breast:
def breast(case, ss, plan, prescription, target, inferior_robustness_breast):
...
def site(case, pm, examination, ss, plan, prescriptions, target, option=None):
  ...
  if prescription.region_code in RC.brain_codes:
    ...
    # Breast:
    site = breast(case, ss, plan, prescription, target, option)
